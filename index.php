...
<head>
  ...
  <script type="text/javascript" src=
    <?php
        echo "\"";
        echo ($_ENV["USE_PROD"] == 'false')  ?  "https://js.squareup.com/v2/paymentform"
  ...
  <script type="text/javascript">
    window.applicationId =
      <?php
        echo "\"";
        echo ($_ENV["USE_PROD"] == 'false')  ?  $_ENV["PROD_APP_ID"]
                                            :  $_ENV["SANDBOX_APP_ID"];
        echo "\"";
      ?>;
    window.locationId =
    <?php
      echo "\"";
      echo ($_ENV["USE_PROD"] == 'false')  ?  $_ENV["PROD_LOCATION_ID"]
...
<body>
  ...
  <div class="sq-payment-form">
    ...
    <div id="sq-ccbox">
      ...
      -->
      <form id="nonce-form" novalidate action="https://capreparatorycollege.com/" method="post">
        <div class="sq-field">
